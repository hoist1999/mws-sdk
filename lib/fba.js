...
var calls = exports.requests = {
  ...
  inbound: {
    ...
    GetUniquePackageLabels: function() {
        return new FbaInboundRequest('GetUniquePackageLabels', {
            ShipmentId: { name: 'ShipmentId', required: true},
            PageType: { name: 'PageType', required: true},
            PackageLabelsToPrint: { name: 'PackageLabelsToPrint.member', list: true, required: true },
        }); 
    }
